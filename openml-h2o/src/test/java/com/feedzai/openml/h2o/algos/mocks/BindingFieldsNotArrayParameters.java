...
/**
 * Mocked class that extends {@link ModelParametersSchemaV3} to match {@link FieldsNotArrayParameters}.
 *
 * @author Miguel Cruz (miguel.cruz@feedzai.com)
 * @since 1.0.7
 */
public class BindingFieldsNotArrayParameters extends ModelParametersSchemaV3 {
