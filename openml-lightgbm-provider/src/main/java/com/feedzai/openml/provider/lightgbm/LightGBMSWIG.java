...
class LightGBMSWIG {
    ...
    double[] getBinaryClassDistribution(final Instance instance) {
        ...
        synchronized (this.swigResources) {
            ...
            // TODO: https://issues.feedzai.com/browse/PULSEDEV-30653 -- enable multithreading?
    ...
    void saveModelToDisk(final Path outputModelFilePath) {
        ...
        int returnCodeLGBM = lightgbmlibJNI.LGBM_BoosterSaveModel(
                swigResources.swigBoosterHandle,
                0, -1,
